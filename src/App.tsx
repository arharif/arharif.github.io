...
class ErrorBoundary extends Component<{ children: ReactNode }, { hasError: boolean; message?: string }> {
  ...
  render() {
    if (this.state.hasError) return <div className="mx-auto max-w-3xl p-10"><div className="glass rounded-2xl p-6"><h1 className="text-2xl font-semibold">Configuration / Runtime Error</h1><p className="mt-3 text-muted">The app hit an error instead of rendering a blank page.</p><pre className="mt-3 text-xs text-rose-300">{this.state.message}</pre></div></div>;
