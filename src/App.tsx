  ...
  return (
    <section className="relative"> 
      ...
      <motion.section aria-label="Explore X1" className="landing-portals grid gap-5 py-4 md:grid-cols-2" initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, ease: 'easeOut' }}>
        ...
        <button className="landing-portal glass" onClick={() => nav('/insights-innovation')}><span className="landing-portal-icon"><Lightbulb aria-hidden="true" /></span><span className="academic-eyebrow">Ideas portal</span><strong>Insights &amp; Innovation</strong><span>Exploring technologies, ideas and perspectives shaping security, innovation and digital transformation.</span><span className="landing-portal-link">Explore Insights <span aria-hidden="true">→</span></span></button>
      </motion.section>
    </section>
  );
}
