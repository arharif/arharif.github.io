export function SecurityMapToolbar({
  ...
  return (
    <div className="roles-toolbar glass rounded-2xl p-4" role="region" aria-label="Security map controls">
      <div className="roles-toolbar-grid">
        <label className="roles-field">
          <span className="roles-field-label">Category</span>
          <select className="mindmap-input" value={category} onChange={(e) => setCategory(e.target.value)} aria-label="Search by category">
