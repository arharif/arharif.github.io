...
const welcomes: Record<AssistantSectionKey, AssistantWelcome> = {
  landing: {
    section: 'landing',
    title: 'Welcome to X1',
    body: 'I can help you navigate the Professional and Personal areas quickly.',
    hint: 'Try: “Show me cybersecurity topics” or “Find personal essays.”',
    visual: '✨',
  },
  professional: {
    section: 'professional',
    title: 'Professional Hub',
    body: 'I can summarize professional topics, chapters, and cybersecurity-focused content.',
  ...
  personal: {
    section: 'personal',
    title: 'Personal Hub',
    body: 'I can help you discover personal reflections, books, and philosophy/anime notes.',
