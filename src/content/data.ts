...
export const seedContent: ContentRecord[] = [
  ...
  { id: 'c2', topicId: 't-grc', slug: 'grc-control-design', title: 'Control Design & Evidence', excerpt: 'Designing evidence-ready controls.', body: chapter('Control Design & Evidence'), contentType: 'professional_chapter', status: 'published', tags: ['controls'], collectionIds: ['col-grc'], createdAt: now, updatedAt: now, authorName: 'X1' },
