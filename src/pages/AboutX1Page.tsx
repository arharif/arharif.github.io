  ...
  return <article className="executive-about">
    <header className="executive-hero glass">
      ...
      <div>
        ...
        <p>I am a Cybersecurity Governance, Risk &amp; Advisory professional with experience across cybersecurity, enterprise risk, regulatory compliance and technology within the payments and financial services environment. I help organisations translate complex cyber risks, regulatory expectations and technical requirements into clear business priorities, pragmatic control strategies and actionable transformation programmes. My focus is on connecting cybersecurity with business objectives, ensuring that investment, remediation and governance decisions are directed toward the risks that matter most.</p>
        <p>My approach goes beyond determining whether an organisation is simply compliant or non compliant. I seek to understand what the business is protecting, where material exposure exists, whether controls are appropriately designed and operating effectively, and where management attention is most needed. From there, I help establish clear ownership, prioritise remediation based on risk and business impact, and provide leadership with the visibility, evidence and confidence required to make informed decisions and strengthen long term cyber resilience.</p>
      </div>
    </header>
