  ...
  return <article className="executive-about">
    <header className="executive-hero glass">
      ...
      <div>
        ...
        <p>I am a <strong>Cybersecurity Governance, Risk &amp; Advisory professional</strong> with experience across cybersecurity, enterprise risk, regulatory compliance and technology within the <strong>payments and financial-services environment</strong>. I help organisations translate complex cyber risks, regulatory expectations and technical requirements into <strong>clear business priorities, pragmatic control strategies and actionable transformation programmes</strong>. My focus is on connecting cybersecurity with business objectives—ensuring that investment, remediation and governance decisions are directed toward the risks that matter most.</p>
        <p>My approach goes beyond determining whether an organisation is simply compliant or non-compliant. I seek to understand <strong>what the business is protecting, where material exposure exists, whether controls are appropriately designed and operating effectively, and where management attention is most needed</strong>. From there, I help establish clear ownership, prioritise remediation based on risk and business impact, and provide leadership with the <strong>visibility, evidence and confidence required to make informed decisions and strengthen long-term cyber resilience</strong>.</p>
      </div>
    </header>

    <section className="about-section" aria-labelledby="capability-title"><p className="academic-eyebrow">Cybersecurity is a System of Connected Capabilities</p><h2 id="capability-title">My Key Advisory Focus</h2><div className="section-copy"><p>Effective cybersecurity depends on how strategy, risk, architecture, identity, resilience and emerging technology work together.</p><p>My focus is on connecting these disciplines so security supports business priorities, informed risk decisions and resilient operations.</p></div>
